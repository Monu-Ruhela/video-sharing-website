...
<h2 class="text-center" style = "font-family : 'Monotype Corsiva' ; color : #E6120E ; font-weight : bold">New Video Request</h2>
<br>
<br>
...
echo "<td>$row[6]</td>";
echo "<td>$row[7]</td>";
echo "<td><a href='$loc' class='btn btn-danger' download>Download</a></td>";

echo "<td><a href='changestatus.php?id=$row[0]' class='btn btn-danger'>ChangeStatus</a></td>";
echo "</tr>";
